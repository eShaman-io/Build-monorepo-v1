      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-2xl font-serif text-gradient mb-4">
                eShaman
              </h3>
              <p className="text-moonstone/70 mb-6 max-w-md">
                Ancient wisdom meets modern technology. Find clarity, peace, and
                guidance through personalized spiritual practices.
              </p>
              <div className="flex gap-4">
                {["Twitter", "Instagram", "YouTube"].map((social) => (
                  ...
                  >
                    <span className="text-moonstone/60 text-sm">
                      {social[0]}
                    </span>
                  </a>
                ))}
            ...
            <ul className="space-y-2">
              {["Features", "Pricing", "Download", "Support"].map((link) => (
                <li key={link}>
                  <a
                    href="#"
                    className="text-moonstone/60 hover:text-moonstone transition-colors duration-200"
                  >
                    {link}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 text-sm">
            <a
              href="#"
              className="text-moonstone/50 hover:text-moonstone/70 transition-colors duration-200"
            >
              Privacy Policy
            </a>
            <a
