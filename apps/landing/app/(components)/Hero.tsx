        ...
        >
          {submitStatus === "success" ? (
            <div className="glass-card max-w-md mx-auto">
              <div className="text-emeraldGlint text-center">
                ...
                <p className="text-moonstone">
                  Welcome to the journey. You&apos;ll hear from us soon.
                </p>
              </div>
            </div>
          ) : (
            <form
              ...
              className="glass p-2 inline-flex gap-2 max-w-md"
            >
              <div className="flex-1">
                ...
                />
                {errors.email && (
                  <p className="text-roseQuartz text-sm mt-1 px-4">
          ...
          {submitStatus === "error" && (
            <p className="text-roseQuartz text-sm mt-2">
